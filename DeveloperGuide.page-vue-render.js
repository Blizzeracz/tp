...
with(this){return _c('p',[_c('strong',[_v("Target user profile")]),_v(": National University of Singapore, School of Computing, Year 2 students.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Our app aims to provide a platform for students to store work/school-related contacts. It will elevate user experience through organized contact categorization and task tagging.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_c('strong',[_v("As a...")])]),_v(" "),_c('th',[_c('strong',[_v("I want to...")])]),_v(" "),_c('th',[_c('strong',[_v("So that I can...")])])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("student")]),_v(" "),_c('td',[_v("Edit existing contact information.")]),_v(" "),_c('td',[_v("Keep it up-to-date.")])]),_v(" "),_c('tr',[_c('td',[_v("student")]),_v(" "),_c('td',[_v("View a list of all my contacts in one place.")]),_v(" "),_c('td',[_v("Easily access my contacts.")])]),_v(" "),_c('tr',[_c('td',[_v("student")]),_v(" "),_c('td',[_v("Create a new contact entry quickly and easily.")]),_v(" "),_c('td',[_v("Save time when adding contacts.")])]),_v(" "),_c('tr',[_c('td',[_v("student")]),_v(" "),_c('td',[_v("Delete existing contacts.")]),_v(" "),_c('td',[_v("Remove unwanted contacts.")])]),_v(" "),_c('tr',[_c('td',[_v("student")]),_v(" "),_c('td',[_v("Add tasks related to a contact/group.")]),_v(" "),_c('td',[_v("Manage tasks efficiently.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified\notherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a person with specific parameters.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook verifies that the name parameter is not null.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook verifies that the phone number contains 8 digits.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook verifies if the group is already created.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook verifies if the accessibility is either public or private. If not specified, sets it to public.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the contact to the address book.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a success message indicating that the contact was added.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The name is missing:\n"),_c('ul',[_c('li',[_v("2a1. AddressBook displays an error message: \"Please input a name.\"\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a list of all contacts in the address book.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit a person using the edit command with the necessary parameters.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook updates the specified contact with the new details.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a success message indicating that the contact was successfully updated.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty:\nUse case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid:")]),_v(" "),_c('ul',[_c('li',[_v("3a1. AddressBook displays an error message.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a task with description and deadline related to specific contacts or groups.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the task.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a success message indicating that the task was added.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Exit the program")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to exit the program.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook terminates the application.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Wed, 11 Oct 2023, 17:21:09 GMT+8]")])])])}
}];
